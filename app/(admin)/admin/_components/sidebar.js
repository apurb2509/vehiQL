...
const Sidebar = () => {
  ...
  return (
    <>
      <div className="hidden md:flex h-full flex-col overflow-y-auto bg-white shadow-sm vorder-r">
        {routes.map((route) => {
          return (
            <Link
              key={route.href}
              ...
              className={cn(
                ...
                pathname === route.href
                ? "text-blue-700 bg-blue-100/50 hover:bg-blue-100 hover:text-bl-700"
                : ""
              )}
            >
